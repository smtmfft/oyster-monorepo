...
mod tests {
    ...
    #[test]
    fn test_revise_rate_cancel_on_non_existent_request() -> Result<()> {
        // setup
        let mut db = TestDb::new();
        let conn = &mut db.conn;
    ...
    #[test]
    fn test_revise_rate_cancel_on_cancelled_request() -> Result<()> {
        // setup
        let mut db = TestDb::new();
        let conn = &mut db.conn;
    ...
    #[test]
    fn test_revise_rate_cancel_on_completed_request() -> Result<()> {
        // setup
        let mut db = TestDb::new();
        let conn = &mut db.conn;
